...
namespace StocksTest
{
    public class StocksControllerTest
    {
        ...
        {
            //_tradingOptions = new IOptions<TradingOptions>();
        ...
        #region Explore
        [Fact]
        public async Task Explore_NullStock_ShouldReturnExploreWithStocksList()
        {
            ...
            IActionResult result = await stocksController.Explore(null as string, true);
